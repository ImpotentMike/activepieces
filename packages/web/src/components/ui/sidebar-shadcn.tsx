...
function SidebarHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        'flex flex-col gap-3 px-6 pt-6 pb-0 group-data-[collapsible=icon]:px-3 group-data-[collapsible=icon]:items-center',
        className,
      )}
      {...props}
    />
...
function SidebarFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        'flex flex-col gap-3 px-6 pt-3 pb-4 border-t border-sidebar-border group-data-[collapsible=icon]:px-3 group-data-[collapsible=icon]:items-center',
        className,
      )}
      {...props}
    />
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn('mx-6 w-auto bg-sidebar-border', className)}
      {...props}
    />
  );
}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        'relative flex w-full min-w-0 flex-col gap-2 px-6 py-2 group-data-[collapsible=icon]:px-3 group-data-[collapsible=icon]:items-center',
        className,
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'flex h-5 shrink-0 items-center px-0 text-sm font-medium tracking-wide uppercase text-muted-foreground ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-1.5 overflow-hidden rounded-lg px-2.5 py-1.5 text-left text-sm font-medium text-sidebar-foreground/80 ring-sidebar-ring outline-hidden transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:font-medium data-active:text-sidebar-accent-foreground data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-1.5! [&>span:last-child]:truncate [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
