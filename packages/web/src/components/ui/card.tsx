...
const cardVariants = cva('rounded-lg border bg-background text-foreground', {
  variants: {
    variant: {
      default: 'shadow-xs',
      interactive:
        'cursor-pointer hover:border-neutral-400 dark:hover:border-neutral-500 transition-colors duration-200 flex flex-col justify-between',
    },
    isSelected: {
      true: 'border-neutral-400 dark:border-neutral-500',
      false: '',
    },
  },
  defaultVariants: {
