...
const teal = {
  50: '166 76% 97%', 100: '167 85% 89%', 200: '168 84% 78%',
  300: '171 77% 64%', 400: '172 66% 50%', 500: '173 80% 40%',
  600: '175 84% 32%', 700: '175 77% 26%', 800: '176 69% 22%',
  900: '176 61% 19%', 950: '179 84% 10%',
};

const slate = {
  50: '210 40% 98%', 100: '210 40% 96%', 200: '214 32% 91%',
  300: '213 27% 84%', 400: '215 20% 65%', 500: '215 16% 47%',
  600: '215 19% 35%', 700: '215 25% 27%', 800: '217 33% 17%',
  900: '222 47% 11%', 950: '229 84% 5%',
};

const green = {
  50: '138 76% 97%', 100: '141 84% 93%', 200: '141 79% 85%',
  300: '142 77% 73%', 400: '142 69% 58%', 500: '142 71% 45%',
  600: '142 76% 36%', 700: '142 72% 29%', 800: '143 64% 24%',
  900: '144 61% 20%', 950: '145 80% 10%',
};

const cyan = {
  50: '183 100% 96%', 100: '185 96% 90%', 200: '186 94% 82%',
  300: '187 92% 69%', 400: '188 86% 53%', 500: '189 94% 43%',
  600: '192 91% 36%', 700: '193 82% 31%', 800: '194 70% 27%',
  900: '196 64% 24%', 950: '197 79% 15%',
};

const pink = {
  50: '327 73% 97%', 100: '326 78% 95%', 200: '326 85% 90%',
  300: '327 87% 82%', 400: '329 86% 70%', 500: '330 81% 60%',
  600: '333 71% 51%', 700: '335 78% 42%', 800: '336 74% 35%',
  900: '336 69% 30%', 950: '336 84% 17%',
};

const fuchsia = {
  50: '289 100% 98%', 100: '287 100% 95%', 200: '288 96% 91%',
  300: '291 93% 83%', 400: '292 91% 73%', 500: '292 84% 61%',
  600: '293 69% 49%', 700: '295 72% 40%', 800: '295 70% 33%',
  900: '297 64% 28%', 950: '297 90% 16%',
};

const amber = {
  50: '48 100% 96%', 100: '48 96% 89%', 200: '48 97% 77%',
  300: '46 97% 65%', 400: '43 96% 56%', 500: '38 92% 50%',
  600: '32 95% 44%', 700: '26 90% 37%', 800: '23 83% 31%',
  900: '22 78% 26%', 950: '21 92% 14%',
};

const purple = {
  50: '270 100% 98%', 100: '269 100% 95%', 200: '269 100% 92%',
  300: '269 97% 85%', 400: '270 95% 75%', 500: '271 91% 65%',
  600: '271 81% 56%', 700: '272 72% 47%', 800: '273 67% 39%',
  900: '274 66% 32%', 950: '274 87% 21%',
};

const orange = {
  50: '33 100% 96%', 100: '34 100% 92%', 200: '32 98% 83%',
  300: '31 97% 72%', 400: '27 96% 61%', 500: '25 95% 53%',
  600: '21 90% 48%', 700: '17 88% 40%', 800: '15 79% 34%',
  900: '15 75% 28%', 950: '13 81% 15%',
};

const sky = {
  50: '204 100% 97%', 100: '204 94% 94%', 200: '201 94% 86%',
  300: '199 95% 74%', 400: '198 93% 60%', 500: '199 89% 48%',
  600: '200 98% 39%', 700: '201 96% 32%', 800: '201 90% 27%',
  900: '202 80% 24%', 950: '204 80% 16%',
};
...
function buildPaletteVars({
  prefix,
  scale,
}: { prefix: string; scale: ShadeScale }): Record<string, string> {
...
function buildThemeVars(config: ThemeConfig): Record<string, string> {
  ...
  return {
    ...
    /* Builder */
    '--builder-background': config.pageBg === '#ffffff' ? '#fbfbfb' : config.pageBg,
...
export function useCurrentTheme(): Iteration {
  ...
  useEffect(() => {
    ...
    const observer = new MutationObserver(() => {
      ...
      if (attr && (attr === 'A' || attr === 'B' || attr === 'C' || attr === 'D' || attr === 'E')) {
        setTheme(attr);
      }
    });
